...
void validateCorrectedIsolationAbs(bool forBarrel = true){
  ...
  for(UInt_t ievent = 0; ievent < maxEvents; ievent++){
	...
	{ ++ieta; };
      ...
      float absRawNeutralIso = std::max(0.0, isoNh + isoPh
					- rho*ea_neutral_total_iso[ieta]);
